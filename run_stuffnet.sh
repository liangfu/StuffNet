...
# pdb tools/train_net.py --gpu 0 --cfg experiments/cfgs/faster_rcnn_end2end-seg.yml --solver models/cityscapes/vgg16/faster_rcnn_end2end/solver-seg.prototxt --weights models/imagenet/VGG_ILSVRC_16_layers.caffemodel --imdb cityscapes_train
