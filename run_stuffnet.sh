...
# python -u ./tools/test_net.py --gpu 0 --def models/cityscapes/vgg16/faster_rcnn_end2end/test-seg.prototxt --net output/faster_rcnn_end2end/cityscapes_2017_train/vgg16_faster_rcnn-seg_iter_20000.caffemodel --imdb cityscapes_val --cfg experiments/cfgs/faster_rcnn_end2end-seg.yml --comp --vis
